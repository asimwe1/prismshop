...
const MacBookPro16: NextPage = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-end justify-start pt-[2.187rem] px-[0rem] pb-[15.875rem] box-border gap-[3rem] leading-[normal] tracking-[normal] text-left text-[3.125rem] text-ghostwhite-100 font-lato mq450:gap-[1.5rem]">
      ...
      <div className="w-[60.688rem] flex flex-row items-start justify-center pt-[0rem] px-[1.25rem] pb-[22.312rem] box-border max-w-full mq900:pb-[14.5rem] mq900:box-border">
        <div className="w-[43.688rem] flex flex-col items-start justify-start gap-[6.062rem] max-w-full mq900:gap-[3rem] mq450:gap-[1.5rem]">
          <div className="self-stretch flex flex-col items-start justify-start gap-[2.437rem] max-w-full mq900:gap-[1.188rem]">
            ...
            <p className="m-0 self-stretch relative text-[1.25rem] capitalize text-darkgray-100 z-[2] mq450:text-[1rem]">
              Discover unique, high-quality products, from trendy fashion to
              stylish home decor and innovative gadgets. There&apos;s something
