...
const Newsletter: NextPage<NewsletterType> = ({ className = "" }) => {
  return (
    ...
    <input
      ...
      className="m-0 self-stretch h-[3.625rem] relative text-inherit font-light font-inherit flex items-center shrink-0 z-[2] mq900:text-[1.5rem] mq450:text-[1.125rem] p-[0.5rem]"
    />
  </div>              
