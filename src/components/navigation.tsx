...
const Navigation: NextPage<NavigationType> = ({ className = "" }) => {
  return (
    <div
      className={`h-[86.313rem] w-[150.063rem] absolute !m-[0] bottom-[-75.375rem] left-[-13.5rem] ${className}`}
    >
      <Image
      width={30}
      height={30}
      ...
      width={30}
      height={25}
        className="absolute top-[46.988rem] left-[0rem] w-[145rem] h-[39.325rem] z-[2]"
        alt=""
